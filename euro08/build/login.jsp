...
<f:view>
	...
	<h2>Navigation</h2>
	<div id="hint">
	Hint: <br /><br />Preinstalled Users<br />--------------------<br />
	ID: admin@euro08.ch<br />
	Password: euro08<br /><br />
	ID: benoist@euro08.ch<br />
	Password: euro08
	</div>
	</div>
	<div id="mainContent">
	...
	<h:form id="formId">
		...
		<br />
		<font color="red"><h:message for="userid"
			errorClass="ValidateError" /></font>
		<br />
		<h:outputText value="Enter Password: " />
		<h:inputSecret required="true" id="password"
			binding="#{login.password}" />
		<br />
		<font color="red"><h:message for="password"
			errorClass="ValidateError" /></font>
		<br />
		...
		<h:outputText value="New User?" />&nbsp;
			<h:commandLink value="Register here" action="register" />
		<br />
		<br />
	</h:form> <!-- end #mainContent --></div>
	<!-- Dieses clear-Element sollte direkt auf das #mainContent-div folgen, um das #container-div anzuweisen, alle untergeordneten Floats aufzunehmen. --><br
		class="clearfloat" />
	<div id="footer">
